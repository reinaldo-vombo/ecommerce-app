            ...
            <Container className="mt-36">
               <div className="grid grid-cols-1 gap-4 md:grid-cols-3 ">
                  <div className="col-span-2 px-3 md:px-0">
                     {blogPost.map((item, index) => index > 1 && (
                        <BlogCard
                           key={item._id}
                           _id={item._id}
                           title={item.title}
                     ...
                     <div className="grid space-y-4">
                        <h2>Comentarios</h2>
                        <div className="flex items-center gap-3 rounded-bl-lg rounded-tr-lg border border-[#9309FF] p-4">
                           <div>
                              <Image src={user} className="w-full rounded-lg" width={300} height={300} alt="user" />
                           </div>
                           <div className="space-y-4">
                              <h3>Reinaldo Vombo</h3>
                              <b>Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur, blanditiis nihil? Quidem iste, odit similique explicabo, maxime accusantium laborum, nulla fugit architecto autem adipisci perspiciatis vero. Illo in ipsum ullam.</b>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div className="col-span-1 space-y-12 px-3">
                     ...
                     <div className="border border-[#9309FF] p-4">
                        <h3 className="mb-4 text-[20px] font-semibold">Noticias relacionadas</h3>
                        <div>
