import { halfBluthooth, middleBluer, minItem1, minItem2, mobileBg, topRightBluer, xBoxController } from "@/public/assets";
   ...
   return (
      <div className="relative h-[100vh] overflow-hidden md:h-[93vh]">
         ...
         <div className="relative w-full mx-0 px-2 py-24 z-10 md:py-60 md:mx-8 md:w-1/2">
            <h1 className="text-center text-5xl leading-[1.5] md:text-left">
               Best{' '}
